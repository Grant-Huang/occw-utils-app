...
def index():
    ...
    <body>
        <div class="container">
            <h1>🎉 OCCW报价系统 - 包测试第一步</h1>
            
            <div class="version">
                <strong>部署版本:</strong> v1.7.0 - 包测试第一步<br>
                <strong>部署时间:</strong> 2025-01-29<br>
                <strong>构建步骤:</strong> 测试pandas和numpy安装<br>
            ...
            <div class="info">
                ...
                <ol>
                    ...
                    <li>⏳ pandas和numpy安装 - <strong>进行中</strong></li>
                    <li>⏳ PyPDF2安装</li>
                    <li>⏳ openpyxl安装</li>
                    <li>⏳ 部署完整OCCW报价系统</li>
                </ol>
            ...
            <div class="warning">
                <h3>⚠️ 当前构建命令</h3>
                <p><code>pip install Flask==2.3.3 pandas==2.0.3 numpy==1.24.3</code></p>
                <p><em>如果包安装失败，请检查构建日志</em></p>
            </div>
        </div>
    </body>
    </html>
...
def health():
    ...
    return jsonify({
        'status': 'healthy',
        'service': 'OCCW Quote System - Package Test Step 1',
        'version': '1.7.0',
        'deploy_time': '2025-01-29'
    })
