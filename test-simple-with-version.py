...
def index():
    ...
    <body>
        <div class="container">
            ...
            <div class="version">
                <strong>部署版本:</strong> v1.4.0 - 版本测试<br>
                <strong>部署时间:</strong> 2025-01-29<br>
                <strong>构建步骤:</strong> 测试版本信息显示<br>
...
def health():
    ...
    return jsonify({
        'status': 'healthy',
        'service': 'OCCW Quote System - Version Test',
        'version': '1.4.0',
        'deploy_time': '2025-01-29'
    })
