#!/usr/bin/env python3
"""
OCCW报价系统 - 包测试第二步：pandas、numpy和PyPDF2
"""
...
def index():
    ...
    <body>
        <div class="container">
            <h1>🎉 OCCW报价系统 - 包测试第二步</h1>
            
            <div class="version">
                <strong>部署版本:</strong> v1.8.0 - 包测试第二步<br>
                <strong>部署时间:</strong> 2025-01-29<br>
                <strong>构建步骤:</strong> 测试pandas、numpy和PyPDF2安装<br>
            ...
            <div class="package">
                ...
                <p><strong>openpyxl:</strong> 未测试</p>
            </div>
            ...
            <div class="info">
                ...
                <ol>
                    ...
                    <li>⏳ PyPDF2安装 - <strong>进行中</strong></li>
                    <li>⏳ openpyxl安装</li>
                    <li>⏳ 部署完整OCCW报价系统</li>
                </ol>
            </div>
            ...
            <div class="warning">
                <h3>⚠️ 当前构建命令</h3>
                <p><code>pip install Flask==2.3.3 pandas==2.0.3 numpy==1.24.3 PyPDF2==3.0.1</code></p>
                <p><em>如果PyPDF2安装失败，请检查构建日志</em></p>
            </div>
        </div>
    </body>
    </html>
...
def health():
    ...
    return jsonify({
        'status': 'healthy',
        'service': 'OCCW Quote System - Package Test Step 2',
        'version': '1.8.0',
        'deploy_time': '2025-01-29'
    })
